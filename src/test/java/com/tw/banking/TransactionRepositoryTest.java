...
class TransactionRepositoryTest {
    ...
    @Test
    public void should_return_transaction_with_date_01012021_amount_is_minus_10_to_transactions_when_allTransactions_given_only_one_transaction_with_today_is_01012021_and_amount_is_10() {
        //given
        Clock clockMock = mock(Clock.class);
        TransactionRepository transactionRepository = new TransactionRepository(clockMock);
        when(clockMock.todayAsString()).thenReturn("01/01/2021");
